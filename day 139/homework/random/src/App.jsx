function App() {
  return (
    <>
      <div className="flex min-w-[250px] w-[60%] m-[20px] flex-wrap text-[white]">
        <div className="h-[400px] min-w-[250px] w-[33%] rounded-[10px_0_0_10px] bg-[#e28525] p-[40px] flex flex-col gap-[10px]">
        ...
        <div className="h-[400px] min-w-[250px] w-[33%] rounded-[0_10px_10px_0] bg-[#00403f] p-[40px] flex flex-col gap-[10px]">
